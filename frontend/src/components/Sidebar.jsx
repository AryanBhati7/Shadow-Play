...
function Sidebar() {
  ...
  return (
    <aside
      className={`z-40 group absolute inset-x-0 bottom-0 w-full shrink-0 border-t border-white bg-[#121212] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] ${
